...
class BasePageLocators:
    ...
    POPULAR_SCIENCE_PUBLICISTICS = (By.XPATH, "//div[@class='row clearfix']//a[@href='https://knigosklad.com.ua/ua/nauchno-populjarnaja']")
    ...
    MEDICINE_HEALTH = (By.XPATH, "//div[@class='row clearfix']//a[@href='https://knigosklad.com.ua/ua/medicina-i-zdorov-e']")
    HOME_EVERYDAYLIFE_LEISURE = (By.XPATH, "//div[@class='row clearfix']//a[@href='https://knigosklad.com.ua/ua/dom-byt-dosug']")
    ...
    PICTURES_BY_NUMBERS = (By.XPATH, "//div[@class='row clearfix']//a[@href='https://knigosklad.com.ua/ua/kartiny-po-nomeram']")
    ...
    MAGIC_ALPHABETS_CHRISTMAS_ALPHABET = (By.XPATH, "//div[@class='product-name']/a[@title='Чарівні абетки. Різдвяна абетка ']")
    FAIRY_ADVENTURES_OF_THE_FAIRY_AND_THE_DISAPPEARING_BRIDE = (By.XPATH, "//div[@class='product-name']/a[@title='Феєричні пригоди. Феї та зникла наречена ']")
